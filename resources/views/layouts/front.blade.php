                            ...
                            <div class="wrap-slick3 flex-sb flex-w">
                                ...
                                <div class="slick3 gallery-lb">
                                    <div class="item-slick3"
                                        data-thumb="{{ asset('front/images/product-detail-01.jpg') }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ asset('front/images/product-detail-01.jpg') }}"
                                                alt="IMG-PRODUCT">
                                    ...
                                    <div class="item-slick3"
                                        data-thumb="{{ asset('front/images/product-detail-02.jpg') }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ asset('front/images/product-detail-02.jpg') }}"
                                                alt="IMG-PRODUCT">
                                    ...
                                    <div class="item-slick3"
                                        data-thumb="{{ asset('front/images/product-detail-03.jpg') }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ asset('front/images/product-detail-03.jpg') }}"
                                                alt="IMG-PRODUCT">
