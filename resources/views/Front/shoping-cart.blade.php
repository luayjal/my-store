                                ...
                                <div class="p-t-15">
                                    ...
                                    <div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                        <select class="js-select2" name="country_code">
                                            ...
                                            @foreach (Symfony\Component\Intl\Countries::getNames() as $code => $countries)
                                            <option value="{{$code}}">{{$countries}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="bor8 bg0 m-b-22">
                                        <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postal_code"
