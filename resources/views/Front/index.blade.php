			...
			<div class="row">
				<div class="col-md-6 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="{{asset('front/images/banner-000.jpg')}}" alt="IMG-BANNER">
				...
				<div class="col-md-6 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{asset('front/images/banner-05.jpg')}}" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{asset('front/images/banner-07.jpg')}}" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{asset('front/images/banner-08.jpg')}}" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{asset('front/images/banner-09.jpg')}}" alt="IMG-BANNER">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0 label-new" data-label="New">
							<img class="img-fluid" src="{{$product->image_url}}" alt="IMG-PRODUCT">
