...
<div class="ps-banner">
    <div class="rev_slider fullscreenbanner" id="home-banner">
        <ul>
            ...
            <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="{{asset('front/images/slider/2.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
        ...
        <div class="ps-section__content pb-50">
            <div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
                        ...
                        <div class="grid-item__content-wrapper">
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail">
                                    ...
                                    <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/1.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
               ...
               <!--      <div class="grid-item nike">
                        <div class="grid-item__content-wrapper">
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                    ...
                    <div class="grid-item adidas">
                        <div class="grid-item__content-wrapper">
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                    ...
                    <div class="grid-item kids">
                        <div class="grid-item__content-wrapper">
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail">
                                    <div class="ps-badge ps-badge--sale"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                    ...
                    <div class="grid-item men">
                        <div class="grid-item__content-wrapper">
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                    ...
                    <div class="grid-item women">
                        <div class="grid-item__content-wrapper">
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/6.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                    ...
                    <div class="grid-item kids">
                        <div class="grid-item__content-wrapper">
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/7.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                    ...
                    <div class="grid-item kids">
                        <div class="grid-item__content-wrapper">
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/8.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
...
<div class="ps-section--offer">
    <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="{{asset('front/images/banner/home-banner-1.png')}}" alt=""></a></div>
    <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img src="{{asset('front/images/banner/home-banner-2.png')}}" alt=""></a></div>
</div>
        ...
        <div class="ps-section__content">
            <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
                <div class="ps-shoes--carousel">
                    <div class="ps-shoe">
                        <div class="ps-shoe__thumbnail">
                            <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/1.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                        </div>
                        <div class="ps-shoe__content">
                            <div class="ps-shoe__variants">
                                <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="ps-shoes--carousel">
                    <div class="ps-shoe">
                        <div class="ps-shoe__thumbnail">
                            <div class="ps-badge"><span>New</span></div>
                            <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                        </div>
                        <div class="ps-shoe__content">
                            <div class="ps-shoe__variants">
                                <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="ps-shoes--carousel">
                    <div class="ps-shoe">
                        <div class="ps-shoe__thumbnail">
                            <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                        </div>
                        <div class="ps-shoe__content">
                            <div class="ps-shoe__variants">
                                <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="ps-shoes--carousel">
                    <div class="ps-shoe">
                        <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                        </div>
                        <div class="ps-shoe__content">
                            <div class="ps-shoe__variants">
                                <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
                ...
                <div class="ps-shoes--carousel">
                    <div class="ps-shoe">
                        <div class="ps-shoe__thumbnail">
                            <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                        </div>
                        <div class="ps-shoe__content">
                            <div class="ps-shoe__variants">
                                <div class="ps-shoe__variant normal"><img src="{{asset('front/images/shoe/2.jpg')}}" alt=""><img src="{{asset('front/images/shoe/3.jpg')}}" alt=""><img src="{{asset('front/images/shoe/4.jpg')}}" alt=""><img src="{{asset('front/images/shoe/5.jpg')}}" alt=""></div>
    ...
    <div class="container">
        <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
            <div class="ps-testimonial">
                <div class="ps-testimonial__thumbnail"><img src="{{asset('front/images/testimonial/1.jpg')}}" alt=""><i class="fa fa-quote-left"></i></div>
                <header>
                    ...
                    <p>Logan May - CEO & Founder Invision 1</p>
                </header>
                <footer>
            ...
            <div class="ps-testimonial">
                <div class="ps-testimonial__thumbnail"><img src="{{asset('front/images/testimonial/2.jpg')}}" alt=""><i class="fa fa-quote-left"></i></div>
                <header>
                    <select class="ps-rating">
                        <option value="1">1</option>
                        <option value="1">2</option>
                    ...
                    <p>Logan May - CEO & Founder Invision 2</p>
                </header>
                <footer>
                    <p>“Dessert pudding dessert jelly beans cupcake sweet caramels gingerbread. Fruitcake biscuit cheesecake. Cookie topping sweet muffin pudding tart bear claw sugar plum croissant. “</p>
                </footer>
            ...
            <div class="ps-testimonial">
                <div class="ps-testimonial__thumbnail"><img src="{{asset('front/images/testimonial/3.jpg')}}" alt=""><i class="fa fa-quote-left"></i></div>
                <header>
                    <select class="ps-rating">
                        <option value="1">1</option>
                        <option value="1">2</option>
                    ...
                    <p>Logan May - CEO & Founder Invision 3</p>
                </header>
                <footer>
                    <p>“Dessert pudding dessert jelly beans cupcake sweet caramels gingerbread. Fruitcake biscuit cheesecake. Cookie topping sweet muffin pudding tart bear claw sugar plum croissant. “</p>
                </footer>
        ...
        <div class="ps-section__content">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                        <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{asset('front/images/blog/1.jpg')}}" alt=""></div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                        <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{asset('front/images/blog/2.jpg')}}" alt=""></div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                    <div class="ps-post">
                        <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{asset('front/images/blog/3.jpg')}}" alt=""></div>
